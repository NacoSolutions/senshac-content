...
For focused autonomous changes, follow `.agents/skills/bounded-warren-task/SKILL.md`. Use positive phrasing and specific instructions that state the desired outcome. Apply defense-in-depth, gentle coding, direct execution, and token economy: inspect the smallest relevant surface, make the smallest safe change, validate boundedly, and avoid speculative or destructive work.
